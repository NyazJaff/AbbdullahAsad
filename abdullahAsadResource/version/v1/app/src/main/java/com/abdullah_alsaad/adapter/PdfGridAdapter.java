...
public class PdfGridAdapter extends BaseAdapter {
    ...
    public PdfGridAdapter(Context context, List<BookItem> bookItemsList, FragmentManager fragmentManager, ProgressBar progressBar, Book book) {
...
//        });
        File file = new File(Environment.getExternalStorageDirectory() +
                File.separator + "abdullahAlSaad/pdf/" + bookItem.getId() + ".png");
        if (file.exists()) {
