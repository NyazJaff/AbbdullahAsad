...
//            getSupportActionBar().setDisplayShowHomeEnabled(true);
    ...
    public void pdfSetup() {
        if (StorageHandler.pdfExists(Integer.valueOf(topic.getParentId() + "" + topic.getId()))) {
            ...
            File file = new File(Environment.getExternalStorageDirectory() +
                    File.separator + "abdullahAlSaad/pdf/" + topic.getParentId() + "" + topic.getId() + ".pdf");
...
//                AppUtil.showToast(context, "downloading file");
    ...
    private void mp3Setup() {
        ...
        if (StorageHandler.mp3Exists(Integer.valueOf(topic.getParentId() + "" + topic.getId()))) {
            File file = new File(Environment.getExternalStorageDirectory() +
                    File.separator + "abdullahAlSaad/mp3/" + topic.getParentId() + "" + topic.getId() + ".mp3");
    ...
    private void downloadFile(String format, String url) {
        ...
        BackgroundAsync backgroundAsync = new BackgroundAsync(Integer.valueOf(topic.getParentId() + "" + topic.getId()), format, context, progressbar);
