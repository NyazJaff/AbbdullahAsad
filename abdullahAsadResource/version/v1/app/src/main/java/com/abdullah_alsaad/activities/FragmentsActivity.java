...
public class FragmentsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void addBook() {
        ...
        final EditText name = (EditText) addBook.findViewById(R.id.name);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (validateInputs(name, pdfURL, imageURL) != false) {
                    ...
                    db.collection("BookItem").orderBy("id", Query.Direction.DESCENDING).limit(1)
                            .get()
    ...
    private void saveToFireStore(String name, String pdfURL, String imageURL, long id) {
        ...
        db.collection("BookItem")
                .add(bookMap)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(getApplicationContext(), R.string.book_created, Toast.LENGTH_SHORT).show();
