...
public class LiveStream extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionBodyTxt = (EditText) findViewById(R.id.questionBodyTxt);
...
//        bookingView.loadUrl("file:///android_asset/mixler.html");
    ...
    private void getSettings() {
        ...
        db.collection("Radio").document("Setting").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
        ...
        db.collection("QandA")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.question_sent, Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    private void loadYoutubeVideo() {
        this.youTubePlayer.loadVideo(radioSetting.getYoutubeUrl());
        youTubePlayer.play();
    }
    ...
    private void loadDialog() {
        ...
        loadDialog.setTitle(R.string.loadingSettings);
    ...
    private void getCurrentQuestions(Date date) {
        ...
        CollectionReference usersRef = db.collection("QandA");
        ...
        db.collection("QandA").whereEqualTo("createdTime", day + "/" + month + "/" + year)
                .get()
...
//
    ...
    private void shareLive() {
        String text = String.format(getApplicationContext().getString(R.string.shareLive), getApplicationContext().getString(R.string.liveStreamText), getApplicationContext().getString(R.string.appLink));
...
//        super.onStart();
//        this.youTubeView.initialize("AIzaSyCquqgJHuQdq3dmeN_ug9komFpA4WruHDs", this);
//        loadYoutubeVideo();
//    }
